        ...
        **kwargs,
        ...
        if resblock_type == "ddpm":
            ResnetBlock = functools.partial(
                ...
                temb_dim=(nf * 4 if time_conditional else None),
            )
...
class NCSNppTime(NCSNpp):
    ...
    def stft(self, sig):
        ...
        spec = torch.stft(
            sig, **{**self.stft_kwargs, "window": window}, return_complex=True
        )
        ...
        if spec.shape[-1] % N_pad != 0:
            ...
            spec = torch.nn.functional.pad(
                spec, (0, num_pad, 0, 0), mode="constant", value=0
            )
...
if __name__ == "__main__":
    ...
    stft_kwargs = {"n_fft": 126, "hop_length": 32, "center": True}
    image_size = 64
    ch_mult = [1, 2, 2, 2]
    nf = 128
    ...
    x, sr = torchaudio.load(
        "/data/lemercier/databases/vctk_derev_with_rir/audio/tt/clean/p376_295_3074_t60=1.06.wav"
    )
